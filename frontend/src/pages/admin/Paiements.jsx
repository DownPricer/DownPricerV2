...
import { CreditCard, Landmark, Activity } from 'lucide-react';
      ...
      <div className="min-h-screen text-white p-4 sm:p-6 md:p-12 selection:bg-orange-500/30 bg-gradient-to-b from-[#090909] via-[#070707] to-black">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-10 md:mb-12">
            ...
            <p className="mt-2 text-zinc-500 text-[10px] md:text-sm font-medium uppercase tracking-wider italic">
              Supervision des flux entrants, acomptes et remboursements
            </p>
          </div>

          {/* Status Card - plus lisible */}
          <Card className="bg-[#0E0E0E] border-white/10 ring-1 ring-white/[0.03] rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden shadow-2xl">
            <CardContent className="p-10 md:p-24 flex flex-col items-center text-center">
              ...
              <div className="h-16 w-16 md:h-20 md:w-20 bg-orange-500/8 border border-orange-500/15 ring-1 ring-orange-500/10 rounded-2xl md:rounded-3xl flex items-center justify-center mb-6 md:mb-8 relative">
              ...
              <p className="text-zinc-400 font-medium mb-6 md:mb-8 text-sm md:text-base max-w-lg leading-relaxed uppercase tracking-wide">
                Interface de gestion des <span className="text-white">acomptes</span>, des{' '}
                <span className="text-white">soldes</span> finaux et des protocoles de{' '}
                <span className="text-white">remboursement</span>.
              </p>

              <Badge className="bg-orange-500/10 text-orange-500 border border-orange-500/20 px-6 py-2 rounded-full text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] animate-pulse">
          ...
          <div className="mt-8 md:mt-12 flex flex-col md:flex-row items-center justify-between gap-4 border-t border-white/[0.06] pt-8">
            <div className="flex items-center gap-6">
              <div className="flex flex-col">
                <span className="text-[8px] font-black text-zinc-600 uppercase tracking-[0.2em]">Stripe Connection</span>
            ...
            <p className="text-[9px] font-bold text-zinc-700 uppercase tracking-[0.4em]">
